...
_Reproduce: `python benchmark.py`. Corpus: 28 malicious (faithful reconstructions of documented campaigns) + 32 realistic benign hard-negatives. Ran in 401 ms._
